...
<a class="btn btn-primary" href="https://support.skyway.io/hc/ja/sections/207333707-Android-SDK" role="button">FAQを見る</a>

## Technical Forum
このテキストはサンプルです。
開発者同士の議論や情報交換、質問のためにコミュニティを提供しています。

<a class="btn btn-primary" href="https://support.skyway.io/hc/ja/community/topics/201518848-Android-SDK" role="button">Technical Forumを見る</a>
