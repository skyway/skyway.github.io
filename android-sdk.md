...
- GitHubからダウンロードしてください
  ...
  [ZIPでダウンロード](https://github.com/nttcom/ECLWebRTC-Android-SDK/releases/latest){: .btn .btn-primary}
  [GitHubでクローン](https://github.com/nttcom/ECLWebRTC-Android-SDK){: .btn .btn-secondary}
...
- SkyWayをご利用のお客様
  ...
  [APIリファレンスを見る](http://nttcom.github.io/skyway/docs/#Android){: .btn .btn-secondary target="_blank"}
